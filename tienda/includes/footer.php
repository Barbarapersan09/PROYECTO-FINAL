...
<div class="contact-info">
    <div class="footer-logo">
        <div class="logo">
            ...
            <img src="./img/El Rincón de Bárbara.ico" width="150px" height="150px">
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> El Rincón de Bárbara.</p>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">bpersan834@g.educaand.com</a></span>
                </div>
            </li>
