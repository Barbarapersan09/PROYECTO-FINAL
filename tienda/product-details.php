...
<html lang="es">
	<head>
		...
		<link rel="shortcut icon" href="./img/El Rincón de Bárbara.png">
	</head>
    <body class="cnt-home">
							...
							<div class="product-social-link m-t-20 text-right">
								...
								<div class="social-icons">
						            <ul class="list-inline">
						                ...
						                <li><a class="fa fa-twitter" href="https://facebook.com/"></a></li>
						                <li><a class="fa fa-linkedin" href="https://facebook.com/"></a></li>
						                <li><a class="fa fa-rss" href="https://facebook.com/</a></li>
						                <li><a class="fa fa-pinterest" href="https://facebook.com/"></a></li>
						            </ul><!-- /.social-icons -->
						        </div>
							</div>
